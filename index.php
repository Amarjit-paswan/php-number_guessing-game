...
do{
    ...
    if($option == 4){
        ...
        // Wait for any key to be processed before returing to menu
    ...
    echo "\n (Show hints? (y/n)): ";
    $showHints = trim(fgets(STDIN)); // Read input and cast to integer
    $guess = (int) fgets(STDIN); // Read input and cast to integer

    // Radomly generate a number to guess (based on difficlty)
